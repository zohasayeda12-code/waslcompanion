...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A companion that helps you build a deeper connection with the Quran." },
      { property: "og:title", content: "Wasl — Read. Understand. Live the Ayah." },
      { property: "og:description", content: "A companion that helps you build a deeper connection with the Quran." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Wasl — Read. Understand. Live the Ayah." },
      { name: "twitter:description", content: "A companion that helps you build a deeper connection with the Quran." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/85366caf-c0b4-40b6-b543-e325b5ce1534" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/85366caf-c0b4-40b6-b543-e325b5ce1534" },
    ],
    links: [
